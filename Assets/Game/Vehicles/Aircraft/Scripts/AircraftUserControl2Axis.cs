...
public class AircraftUserControl2Axis : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        AdjustInputControls(ref roll, ref pitch, ref throttle);
    ...
    private void AdjustInputControls(ref float roll, ref float pitch, ref float throttle)
    {
