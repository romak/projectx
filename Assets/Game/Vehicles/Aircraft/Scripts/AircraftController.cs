...
public class AircraftController : MonoBehaviour
{
    ...
    [SerializeField]
    private float lift = 0.002f;                       // The amount of lift generated by the aeroplane moving forwards.
    [SerializeField]
    private float zeroLiftSpeed = 300;                 // The speed at which lift is no longer applied.
    [SerializeField]
    private float rollEffect = 1f;                     // The strength of effect for roll input.
    [SerializeField]
    private float pitchEffect = 1f;                    // The strength of effect for pitch input.
    [SerializeField]
    private float yawEffect = 0.2f;                    // The strength of effect for yaw input.
    [SerializeField]
    private float bankedTurnEffect = 0.5f;             // The amount of turn from doing a banked turn.
    [SerializeField]
    private float aerodynamicEffect = 0.02f;           // How much aerodynamics affect the speed of the aeroplane.
    [SerializeField]
    private float autoTurnPitch = 0.5f;                // How much the aeroplane automatically pitches when in a banked turn.
    [SerializeField]
    private float autoRollLevel = 0.2f;                // How much the aeroplane tries to level when not rolling.
    [SerializeField]
    private float autoPitchLevel = 0.2f;               // How much the aeroplane tries to level when not pitching.
    [SerializeField]
    private float airBrakesEffect = 3f;                // How much the air brakes effect the drag.
    [SerializeField]
    private float throttleChangeSpeed = 0.3f;          // The speed with which the throttle changes.
    [SerializeField]
...
//        ForwardSpeed = Mathf.Max(0, localVelocity.z);
        ...
        // roma_k: speed limit in miles
        ForwardSpeed = Mathf.Max(0, Mathf.Clamp(localVelocity.z, minSpeed, maxSpeed));
        // roma_k: speed limit
    }
